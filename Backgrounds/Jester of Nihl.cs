...
{
    public class PassiveAbility_JesterOfNihlJokerLaughCryM : PassiveAbilityBase
    {
        private AudioClip[] _oldEnemytheme;
        private SephirahType sephirah;
        public override void OnWaveStart()
        {
            Singleton<StageController>.Instance.AddEgoMapByAssimilation("ClownOfNihil");
            SingletonBehavior<BattleCamManager>.Instance.SetCreatureFilter();
            //I used Moutain of Bodies for third warning.
