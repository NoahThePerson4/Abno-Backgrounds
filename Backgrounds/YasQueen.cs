...
{
    public class PassiveAbility_YasQueenSlayGasLightGatKeepGirlBossM : PassiveAbilityBase
    {
        public override void OnWaveStart()
        {
            Singleton<StageController>.Instance.AddEgoMapByAssimilation("QueenOfHatred_FINAL");
