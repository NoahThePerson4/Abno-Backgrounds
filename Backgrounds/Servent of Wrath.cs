...
{
    public class PassiveAbility_ServentWrathFriiendYesNoM : PassiveAbilityBase
    {
        private AudioClip[] _oldEnemytheme;
        private SephirahType sephirah;
        public override void OnWaveStart()
        {
            Singleton<StageController>.Instance.AddEgoMapByAssimilation("ServantOfWrath");
            SingletonBehavior<BattleCamManager>.Instance.SetCreatureFilter();
            //I used Red Hood (Little Red) for second warning
